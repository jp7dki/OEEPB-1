...
void bme280_init(void){
    ...
    //---- SPI(BME280) -------------------------
    gpio_init(SENS_SCK_PIN);
    gpio_init(SENS_SDI_PIN);
    gpio_init(SENS_SDO_PIN);
    gpio_init(SENS_CSB_PIN);
    gpio_set_dir(SENS_SCK_PIN, GPIO_OUT);
    gpio_set_dir(SENS_SDI_PIN, GPIO_IN);
    gpio_set_dir(SENS_SDO_PIN, GPIO_OUT);
